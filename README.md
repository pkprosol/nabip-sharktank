...
Static landing page for the NABIP Shark Tank — hosted by NABIP Illinois at the NABIP Annual Convention, Atlantic City, NJ, Monday, June 29, 2026 (12:30–2:30 PM, exhibit hall).
...
- NABIP Illinois logo + brand colors (currently using Validation Institute palette)
- Final panel of judges beyond Al Lewis
- Application deadline date (recommend ~3 weeks pre-event, e.g., June 8, 2026)
- Specific room / booth within the Atlantic City exhibit hall
- Confirm whether to lead with NABIP Illinois or the broader NABIP Annual Convention framing
...
4. Custom domain: point DNS (e.g. `nabipilsharktank.validationinstitute.com`) to Render per their docs.
